        ...
        <div className="space-y-5">
          <div className="p-4 rounded-2xl bg-rose-50/60 border border-rose-200 space-y-4">
            ...
            <p className="text-xs text-stone-500">
              Upload or link a voice message. The recipient will see an animated waveform player with your transcription.
            </p>
            <div>
              <div className="flex items-center justify-between">
            ...
            <div>
              <label className="text-xs font-semibold text-stone-700">Sender Name / Signature</label>
              <input
                type="text"
            ...
            <MediaPickButton
              fieldKey="audioUrl"
              label="Voice Audio File (Upload or Paste URL)"
              filterType="audio"
              currentUrl={content.audioUrl}
              placeholder="https://example.com/my-voice-note.mp3"
              helpText="Upload your recorded voice note or paste a direct audio link."
            />
            <div>
              <label className="text-xs font-semibold text-stone-700">Duration Label <span className="text-stone-400 font-normal">(e.g. "0:42")</span></label>
              <input
                type="text"
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Type what you said in the audio — shown as a quote to the recipient."
                onChange={(e) => updateField('transcription', e.target.value)}
                className="w-full mt-1.5 p-3 rounded-xl border border-stone-300 text-xs bg-white text-stone-800 focus:ring-2 focus:ring-rose-400 focus:outline-none leading-relaxed"
              />
            </div>
            <div>
              ...
              <input
                ...
                placeholder="e.g. Last night, or Today"
