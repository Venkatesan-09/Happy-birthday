...
export const PublicRecipientView: React.FC<PublicRecipientViewProps> = ({
  ...
  return (
    <div className="relative">
      ...
      <div className="fixed top-4 left-4 z-50 bg-white/90 backdrop-blur-md px-3.5 py-1.5 rounded-full border border-amber-200/80 shadow-md flex items-center gap-2.5 text-xs text-stone-700">
        <Sparkles className="w-3.5 h-3.5 text-amber-600" />
        <span className="font-medium">
          {experience.recipient?.name}’s Journey: {progressPercent}% Explored
        </span>
